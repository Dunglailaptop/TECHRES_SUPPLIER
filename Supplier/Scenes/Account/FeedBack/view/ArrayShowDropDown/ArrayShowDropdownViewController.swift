...
class ArrayShowDropdownViewController<Element> : UITableViewController {
    ...
    override func viewDidLoad() {
        let nib = UINib.init(nibName: "ItemDropDownTableViewCell", bundle: nil)
        self.tableView.register(nib, forCellReuseIdentifier: "ItemDropDownTableViewCell")
    }
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        let cell = tableView.dequeueReusableCell(withIdentifier: "ItemDropDownTableViewCell", for: indexPath) as! ItemDropDownTableViewCell
