...
class ListReturnCategoryReportTableViewCell: UITableViewCell {
    ...
    var viewModel: ReturnCategoryReportViewModel?{
        didSet{}
    }
    ...
    var data: MaterialReportData?{
        didSet{
            ...
            lbl_total_amount_category.text = Utils.stringVietnameseMoneyFormatWithNumber(amount: data?.total_return ?? 0)
