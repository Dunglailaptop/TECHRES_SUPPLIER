//
//  ReturnCategoryReportViewModel.swift
//  Techres-Seemt
//
...
class ReturnCategoryReportViewModel: BaseViewModel {
    private(set) weak var view: ReturnCategoryReportViewController?
    private var router: ReturnCategoryReportRouter?
    ...
    func bind(view: ReturnCategoryReportViewController, router: ReturnCategoryReportRouter){
        self.view = view
        self.router = router
...
extension ReturnCategoryReportViewModel{
    // báo cáo danh mục
