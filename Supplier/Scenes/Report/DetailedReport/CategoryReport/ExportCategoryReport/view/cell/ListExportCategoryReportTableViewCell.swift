...
class ListExportCategoryReportTableViewCell: UITableViewCell {
    ...
    var viewModel: ExportCategoryReportViewModel?{
        didSet{}
    }
    ...
    var data: MaterialReportData?{
        didSet{
            ...
            lbl_total_amount_category.text = Utils.stringVietnameseMoneyFormatWithNumber(amount: data?.total_export ?? 0)
