//
//  ImportCategoryReportViewModel.swift
//  Techres-Seemt
//
...
class ImportCategoryReportViewModel: BaseViewModel {
    private(set) weak var view: ImportCategoryReportViewController?
    private var router: ImportCategoryReportRouter?
    ...
    func bind(view: ImportCategoryReportViewController, router: ImportCategoryReportRouter){
        self.view = view
        self.router = router
...
extension ImportCategoryReportViewModel{
    // báo cáo danh mục
