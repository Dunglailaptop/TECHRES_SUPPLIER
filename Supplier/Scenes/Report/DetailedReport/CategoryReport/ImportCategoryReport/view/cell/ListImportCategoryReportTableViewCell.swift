...
class ListImportCategoryReportTableViewCell: UITableViewCell {
    ...
    var viewModel: ImportCategoryReportViewModel?{
        didSet{}
    }
    ...
    var data: MaterialReportData?{
        didSet{
            ...
            lbl_total_amount_category.text = Utils.stringVietnameseMoneyFormatWithNumber(amount: data?.total_import ?? 0)
