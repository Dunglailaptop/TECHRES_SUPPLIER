//
//  RemainingCategoryReportViewModel.swift
//  Techres-Seemt
//
...
class RemainingCategoryReportViewModel: BaseViewModel {
    private(set) weak var view: RemainingCategoryReportViewController?
    private var router: RemainingCategoryReportRouter?
    ...
    func bind(view: RemainingCategoryReportViewController, router: RemainingCategoryReportRouter){
        self.view = view
        self.router = router
...
extension RemainingCategoryReportViewModel{
    // báo cáo danh mục
