//
//  CancelCategoryReportViewController.swift
//  Techres-Seemt
//
...
class CancelCategoryReportViewController: BaseViewController {
    
    var viewModel = CancelCategoryReportViewModel()
    var router = CancelCategoryReportRouter()
