//
//  CancelReportViewController+Extension.swift
//  TECHRES-SUPPLIER
//
...
extension CancelReportViewController {
    func registerCell() {
        
        let CancelItemTableViewCell = UINib(nibName: "CancelItemTableViewCell", bundle: .main)
        tableView.register(CancelItemTableViewCell, forCellReuseIdentifier: "CancelItemTableViewCell")
    ...
    func bindTableViewData() {
        viewModel.dataArray.bind(to: tableView.rx.items(cellIdentifier: "CancelItemTableViewCell", cellType: CancelItemTableViewCell.self))
            {  (row, data, cell) in
                cell.data = data
...
//
    ...
    @objc func refresh(_ sender: AnyObject) {
       // Code to refresh table view
        viewModel.clearandCallAPI()
        refreshControl.endRefreshing()
    }
}

extension CancelReportViewController: UITableViewDelegate {
