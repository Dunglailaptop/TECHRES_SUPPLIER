//
//  ImportItemsReportViewModel.swift
//  Techres-Seemt
//
...
class ImportItemsReportViewModel: BaseViewModel {
    private(set) weak var view: ImportItemsReportViewController?
    private var router: ImportItemsReportRouter?
    ...
    func bind(view: ImportItemsReportViewController, router: ImportItemsReportRouter){
        self.view = view
        self.router = router
...
extension ImportItemsReportViewModel{
    //báo cáo Mặt hàng
