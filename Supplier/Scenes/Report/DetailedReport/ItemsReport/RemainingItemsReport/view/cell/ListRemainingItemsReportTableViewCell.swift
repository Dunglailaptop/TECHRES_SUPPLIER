//
//  ListRemainingItemsReportTableViewCell.swift
//  Techres-Seemt
//
...
class ListRemainingItemsReportTableViewCell: UITableViewCell {
    ...
    var viewModel: RemainingItemsReportViewModel?{
        didSet{}
    }
    ...
    var data: MaterialReportData?{
        didSet{
            ...
            lbl_total_amount_category.text = Utils.stringVietnameseMoneyFormatWithNumber(amount: data?.total_remaining ?? 0)
