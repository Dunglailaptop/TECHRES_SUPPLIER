//
//  ExportItemsReportViewModel.swift
//  Techres-Seemt
//
...
class ExportItemsReportViewModel: BaseViewModel {
    private(set) weak var view: ExportItemsReportViewController?
    private var router: ExportItemsReportRouter?
    ...
    func bind(view: ExportItemsReportViewController, router: ExportItemsReportRouter){
        self.view = view
        self.router = router
...
extension ExportItemsReportViewModel{
    //báo cáo Mặt hàng
