//
//  ReturnItemsReportViewModel.swift
//  Techres-Seemt
//
...
class ReturnItemsReportViewModel: BaseViewModel {
    private(set) weak var view: ReturnItemsReportViewController?
    private var router: ReturnItemsReportRouter?
    ...
    func bind(view: ReturnItemsReportViewController, router: ReturnItemsReportRouter){
        self.view = view
        self.router = router
...
extension ReturnItemsReportViewModel{
    //báo cáo Mặt hàng
