//
//  UnitManagementViewController + Extension + Popup.swift
//  TECHRES-SUPPLIER
//
...
extension UnitManagementViewController: DialogConfirmDelegate{
    ...
    func prensentDialogNotify(content:String,materialUnitStatus:[MaterialUnitStatus]){
        let dialog = DialogShowUsingMaterialUnitViewController()
        dialog.content = content
        dialog.dataArray.accept(materialUnitStatus)
