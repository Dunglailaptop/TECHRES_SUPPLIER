//
//  DetailCancelExportInventoryViewController.swift
//  TECHRES-SUPPLIER
//
...
class DetailCancelExportInventoryViewController: BaseViewController {

    var viewModel = DetailCancelExportInventoryViewModel()
    var router = DetailCancelExportInventoryRouter()
