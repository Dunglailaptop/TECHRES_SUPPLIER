//
//  PendingExportInventoryViewController.swift
//  Techres-Seemt
//
...
class PendingExportInventoryViewController: BaseViewController {

    var viewModel = PendingExportInventoryViewModel()
    var router = PendingExportInventoryRouter()
