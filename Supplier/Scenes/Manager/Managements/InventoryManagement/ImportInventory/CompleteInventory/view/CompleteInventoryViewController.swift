//
//  CompleteInventoryViewController.swift
//  Techres-Seemt
//
...
class CompleteInventoryViewController: BaseViewController {

    var viewModel = CompleteInventoryViewModel()
    var router = CompleteInventoryRouter()
