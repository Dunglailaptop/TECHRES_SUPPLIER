//
//  DetailCompleteInventoryViewController.swift
//  TECHRES-SUPPLIER
//
...
class DetailCompleteInventoryViewController: BaseViewController {

    var viewModel = DetailCompleteInventoryViewModel()
    var router = DetailCompleteInventoryRouter()
