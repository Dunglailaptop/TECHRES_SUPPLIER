//
//  ImportedInventoryViewController.swift
//  Techres-Seemt
//
...
class ImportedInventoryViewController: BaseViewController {

    var viewModel = ImportedInventoryViewModel()
    var router = ImportedInventoryRouter()
