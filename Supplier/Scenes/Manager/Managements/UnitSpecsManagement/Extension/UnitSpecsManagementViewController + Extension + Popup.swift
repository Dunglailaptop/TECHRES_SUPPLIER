//
//  UnitSpecsManagementViewController + Extension + Popup.swift
//  TECHRES-SUPPLIER
//
...
extension UnitSpecsManagementViewController: DialogConfirmDelegate{
    ...
    func prensentDialogNotify(content:String,unitSpecsStatus:[UnitSpecificationStatus]){
        let dialog = DialgoShowUsingUnitSpecsViewController()
        dialog.content = content
        dialog.dataArray.accept(unitSpecsStatus)
