//
//  DetailCompleteOrderTableViewCell.swift
//  Techres-Seemt
//
...
class DetailCompleteOrderTableViewCell: UITableViewCell {
    ...
    @IBOutlet weak var lbl_accept_quantity: UILabel! // SL nhận
    @IBOutlet weak var lbl_return_quantity: UILabel! // SL trả
    ...
    var data: SupplierOrdersDetailResponse? {
        didSet{
            ...
            self.lbl_accept_quantity.text = Utils.stringQuantityFormatWithNumberDouble(amount: data?.accept_quantity ?? 0)
            self.lbl_return_quantity.text = Utils.stringQuantityFormatWithNumberDouble(amount: data?.return_quantity ?? 0)
