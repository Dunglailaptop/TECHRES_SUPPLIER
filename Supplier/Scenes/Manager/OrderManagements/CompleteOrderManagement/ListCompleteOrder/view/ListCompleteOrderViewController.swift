//
//  ListCompleteOrderViewController.swift
//  Techres-Seemt
//
...
class ListCompleteOrderViewController: BaseViewController {

    var viewModel = ListCompleteOrderViewModel()
    var router = ListCompleteOrderRouter()
