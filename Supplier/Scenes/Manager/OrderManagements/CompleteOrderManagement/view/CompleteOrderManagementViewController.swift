//
//  CompleteOrderManagementViewController.swift
//  Techres-Seemt
//
...
class CompleteOrderManagementViewController: BaseViewController {
    
    var viewModel = CompleteOrderManagementViewModel()
    var router = CompleteOrderManagementRouter()
