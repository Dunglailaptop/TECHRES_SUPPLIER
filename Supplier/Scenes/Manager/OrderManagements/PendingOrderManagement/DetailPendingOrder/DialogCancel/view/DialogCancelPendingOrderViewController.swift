//
//  DialogCancelPendingOrderViewController.swift
//  Techres-Seemt
//
...
class DialogCancelPendingOrderViewController: BaseViewController {
    ...
    // Đăng ký nhận thông báo bàn phím trong viewDidLoad() hoặc viewWillAppear()
