//
//  ListDeliveringOrderViewController.swift
//  Techres-Seemt
//
...
class ListDeliveringOrderViewController: BaseViewController {

    var viewModel = ListDeliveringOrderViewModel()
    var router = ListDeliveringOrderRouter()
