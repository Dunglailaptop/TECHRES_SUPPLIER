...
//  DateTimePicker
//
//  Created by Kelvin on 09/04/2020.
//  Copyright © 2020 OVERATE-VNTECH. All rights reserved.
//
...
//        colonLabel1.isHidden = isDatePickerOnly
        colonLabel1.isHidden = minuteTableView.isHidden == true && hourTableView.isHidden == true ? true : (!is12HourFormat || isDatePickerOnly)
        ...
        separatorTopView.isHidden = minuteTableView.isHidden == true ? true : isDatePickerOnly
        ...
        separatorBottomView.isHidden = minuteTableView.isHidden == true ? true : isDatePickerOnly
