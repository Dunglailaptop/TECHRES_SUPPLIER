...
//
   ...
   static let sharedHUD : JHProgressHUD =  { JHProgressHUD()}()
    ...
    func showInView(_ view : UIView, withHeader title : String?, andFooter footer : String?)
    {
        ...
        activityIndicator.color = ColorUtils.green_007()//UIColor(red: 211.0/255.0, green: 211.0/255.0, blue: 211.0/255.0, alpha: 1.0)
        ...
        let imageLoading = UIImage(named: "AppIcon")
        ...
        loading.tintColor = ColorUtils.green_007()
        loading.layer.cornerRadius = 20
