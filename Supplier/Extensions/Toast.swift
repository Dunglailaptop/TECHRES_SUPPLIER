...
//  Sale
//
//  Created by macmini_techres_04 on 21/02/2023.
...
class Toast {
    static func show(message: String, controller: UIViewController) {
        ...
        toastContainer.backgroundColor = UIColor.black.withAlphaComponent(0.4)
...
//        toastLabel.font.withSize(10)
        ...
        let c1 = NSLayoutConstraint(item: toastContainer, attribute: .leading, relatedBy: .equal, toItem: controller.view, attribute: .leading, multiplier: 1, constant: 85)
        let c2 = NSLayoutConstraint(item: toastContainer, attribute: .trailing, relatedBy: .equal, toItem: controller.view, attribute: .trailing, multiplier: 1, constant: -85)
        ...
        UIView.animate(withDuration: 0.5, delay: 0.0, options: .curveEaseIn, animations: {
            ...
            UIView.animate(withDuration: 1, delay: 3.5, options: .curveEaseOut, animations: {
                toastContainer.alpha = 0.0
            }, completion: {_ in
