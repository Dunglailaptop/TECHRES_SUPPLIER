...
//            tableheightX = rowHeight * CGFloat(dataArray.count) //This code is from library
            tableheightX = dataArray.count > 0 ? rowHeight * CGFloat(dataArray.count) : listHeight //this code is pham khanh huy's
        } else {
    ...
    public func showListWithoutAnimation() {
        if parentController == nil {
            parentController = parentViewController
        }
        backgroundView.frame = parentController?.view.frame ?? backgroundView.frame
...
//            tableheightX = rowHeight * CGFloat(dataArray.count) //This code is from library
    ...
    public func hideListWithoutAnimation() {
        TableWillDisappearCompletion()
...
extension DropDown: UITableViewDelegate {
    public func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        ...
        UIView.animate(withDuration: 0.5,
                       ...
                       completion: { (_) -> Void in
                            self.text = self.showTextAfterSelect ? "\(selectedText)" : ""
